...
def choice(lst1, min, max):
    # lst_1 = []
    # for i in range(len(lst1)):
    #     if lst1[i]>= min and lst1[i]<= max:
    #         lst_1.append((i,lst1[i]))   
    lst_1 = [(i,lst1[i]) for i in range(len(lst1)) if lst1[i]>= min and lst1[i]<= max]
    return lst_1
lst1 = [-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7]
print (choice(lst1, 2, 10))
print (choice(lst1, 2, 9))
print (choice(lst1, 0, 6))
